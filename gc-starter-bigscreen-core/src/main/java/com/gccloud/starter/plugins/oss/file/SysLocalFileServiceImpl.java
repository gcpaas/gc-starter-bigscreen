...
public class SysLocalFileServiceImpl implements ISysOssService {
    ...
    @Override
    public SysFileEntity upload(MultipartFile file, SysFileEntity fileEntity, HttpServletResponse response, HttpServletRequest request) {
